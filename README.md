...
OrganikMarket,
ASP.NET Core MVC ve Entity Framework Core kullanılarak geliştirilmiş,6 farklı tasarım deseninin (design pattern) uçtan uca uygulandığı bir organik gıda e-ticaret platformudur. 
Proje; ürün yönetimi, sepet, karşılaştırma, ödeme ve sipariş süreçlerinin yanı sıra içerik yönetimi yapılabilen kapsamlı bir admin paneli içerir.
